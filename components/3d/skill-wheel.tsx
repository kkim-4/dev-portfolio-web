...
const skillsData = [
  ...
  },
  {
    ...
    color: "#3178C6",
    position: [0, 3, 0],
    description: "Web development, asynchronous programming, and performance tuning",
  },
  {
    ...
    color: "#3776AB",
    position: [-2.1, 2.1, 0],
    description: "Machine learning, data analysis, and model development with Python",
  },
  {
    name: "AWS",
    category: "Cloud",
  ...
  },
  {
    ...
    color: "#ff0000",
    position: [0, -3, 0],
    description: "Object-oriented programming, application using SpringBoot, and performance tuning",
  },
  {
    name: "GraphQL",
    category: "Backend",
